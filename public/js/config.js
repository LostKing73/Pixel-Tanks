window.sourceMap = {
  ...
  cosmetic: {
    path: 'cosmetics',
    common: ['sculk', 'sculkcrown', 'medic', 'police', 'small_scratch', 'spikes', 'moustache', 'pumpkin_face', 'army', 'hardhat', 'halo', 'lego', 'present', 'pumpkin_hat', 'top_hat', 'stamp', 'dead', 'earmuffs', 'ban', 'sweat', 'lava', 'ink', 'bricks'],
