window.sourceMap = {
  ...
  cosmetic: {
    path: 'cosmetics',
    common: ['author_body', 'author_hat', 'sculk', 'sculkcrown', 'medic', 'police', 'small_scratch', 'spikes', 'moustache', 'pumpkin_face', 'army', 'hardhat', 'halo', 'lego', 'present', 'pumpkin_hat', 'top_hat', 'stamp', 'dead', 'earmuffs', 'ban', 'sweat', 'lava', 'ink', 'bricks'],
    ...
    mythic: ['terminator', 'mlg_glasses', 'power_armor', 'corrupted', 'thedark'],
    meta: {},
  },
  deathEffect: {
    path: 'animations',
